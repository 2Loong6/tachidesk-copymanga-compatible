...
if [ "${LOGGING:-file}" != "file" ]; then
  ...
  exec java -Xbootclasspath/a:"/home/suwayomi/startup/chinese-utils-1.0.jar" -jar "/home/suwayomi/startup/tachidesk_latest.jar" > /home/suwayomi/.local/share/Tachidesk/logfile.log 2>&1;
fi